...
void Get_DateTime()
{
	DateTime[0] = Read_DS(SECOND);    //秒
	DateTime[1] = Read_DS(MINUTE);    //秒
	DateTime[2] = Read_DS(HOUR);    //秒
	DateTime[3] = Read_DS(DAY);    //秒
	DateTime[4] = Read_DS(MONTH);    //秒
	DateTime[5] = Read_DS(YEAR);    //秒
	DateTime[6] = Read_DS(CENTURY);    //秒
	DateTime[7] = Read_DS(WEEKDAY);    //秒
}
