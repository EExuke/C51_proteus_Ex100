...
// ASCII及汉字显示
//-----------------------------------------------------------------
void Display_Str_at_xy(INT8U x,INT8U y,char *Buffer,INT8U wb) reentrant
{
	char c1,c2,cData;
	INT8U i = 0,j,k,uLen;	
	uLen = strlen(Buffer);
...
void Pixel(INT8U x,INT8U y, INT8U Mode) reentrant
{
	...
	LCD_Write_Command(LCD_BIT_OP | dat); 
}

//-----------------------------------------------------------------
// 两数交换
//-----------------------------------------------------------------
void Exchange(INT8U *a, INT8U *b) reentrant
{
   INT8U t;
   t = *a; *a = *b; *b = t;
}
...
//-----------------------------------------------------------------
void Line(INT8U x1,INT8U y1, INT8U x2,INT8U y2, INT8U Mode) reentrant
{
    INT8U x,y;        //绘点坐标
    float k,b;        //直线斜率与偏移
...
// 绘制图像
//-----------------------------------------------------------------
void Draw_Image(INT8U *G_Buffer, INT8U Start_Row, INT8U Start_Col) reentrant
{   
